        ...
        <div className="row container-cards">
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4">
            ...
            >
              ...
              <div className="row">
                <span className="title-card">App Development</span>
              </div>
              <div className="row">
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4">
            ...
            >
              ...
              <div className="row">
                <span className="title-card">Website Desing</span>
              </div>
              <div className="row">
                <span className="paragraph-card">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          <div className="col-sm-12 col-md-4 col-lg-4 col-xl-4">
            ...
            >
              ...
              <div className="row">
                <span className="title-card">Design Research</span>
              </div>
              <div className="row">
                <span className="paragraph-card">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
